# ecommerce-fulfillment-eda
 E-Commerce Fulfillment Optimization — Executive Analysis

**Analyst:** Soham Dutta | **Scope:** 10,000-order fulfillment dataset (synthetic, operationally realistic) | **Tools:** Python (pandas, numpy, matplotlib, seaborn)
